        ...
        >
            ...
            <PanelStyled sizeRatio={sizeRatio} background={PanelBackImage}>
                <Text>
                    ...
                    </Text> Отправляйся на важную миссию — пройди все уровни и доберись до лампы наверху. Зажечь её могут только профессионалы нового поколения. Пройди 3 этапа и стань таким профессионалом.
                </Text>
            </PanelStyled>
